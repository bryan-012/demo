---
title: "Hands_On_Exercise_8: Visualising and Analysing Geographical Data"
format: html
date: "March 13 2025"
...
-   dplyr for wrangling data and sf for handling geospatial data.
...
Notice that, we only need to install tidyverse instead of readr, tidyr and dplyr individually. 21.3 Importing Data into R
:::

# 21.3.1 The Data Two data set will be used to create the choropleth map.
