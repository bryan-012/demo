...
## 1.7.2 Geometric Objects using geom_dotplot
...
## 1.7.3 Geometric objects using geom_histogram
...
## 1.7.6 Geometric Objects using geom-density()
...
## 1.7.7 Geometric object using geom_boxplot
...
## 1.7.8 Geoemetric object using geom_violin
...
## 1.7.9 Geometric Objects using geom_point()
...
## 1.7.10 geom objects can be combined into a single plot
...
## 1.8.4 Plotting a best fit curve
...
-   [`coord_quickmap()`](https://ggplot2.tidyverse.org/reference/co
```
...
## 1.10.2 Changing the range of x and y axis
